//https://github.com/CptPotato/GodotThings/tree/master/ProceduralCheckerboard
shader_type spatial;
render_mode blend_mix, depth_draw_always, cull_back, diffuse_burley, specular_schlick_ggx;

uniform vec4 albedo : hint_color = vec4(0.6f, 0.6f, 0.6f, 1.0f);
uniform float squares = 1.0;
...
void fragment()
{
	...
	vec3 coord = Position.xyz * squares;
	vec3 ddxyz = fwidth(coord) * edge_blur;
